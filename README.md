...
![Меню](https://github.com/Knysha04/SoftwareEngineering/blob/main/pic/3.png)
## Выводы
Для связи между локальным репозиторием и удалённым нужно инициализирвоать репозиторий локально.
  
## Задание 4
### Подготовка файлов
![Меню](https://github.com/Knysha04/SoftwareEngineering/blob/main/pic/4.png)
## Выводы
Есть команды для добавления одног офайла и проверки статуса файлов.

## Задание 5
### Фиксация изменений
![Меню](https://github.com/Knysha04/SoftwareEngineering/blob/main/pic/5.png)
## Выводы
...
![Меню](https://github.com/Knysha04/SoftwareEngineering/blob/main/pic/6.png)
## Выводы
...
## Задание 7
### Ветвление
![Меню](https://github.com/Knysha04/SoftwareEngineering/blob/main/pic/7.png)
## Выводы
...
![Меню](https://github.com/Knysha04/SoftwareEngineering/blob/main/pic/8.png)
## Выводы
...
![Меню](https://github.com/Knysha04/SoftwareEngineering/blob/main/pic/9.png)
## Выводы
...
![Меню](https://github.com/Knysha04/SoftwareEngineering/blob/main/pic/10.png)
## Выводы
git log / git diff - команды для отслеживания изменений в коммитах

## Задание 11
### Возвращение файла к предыдущему (определенному) состоянию
![Меню](https://github.com/Knysha04/SoftwareEngineering/blob/main/pic/11.png)
## Выводы
...
![Меню](https://github.com/Knysha04/SoftwareEngineering/blob/main/pic/12.png)
## Выводы
...
## Задание 13
### Исправление коммита
![Меню](https://github.com/Knysha04/SoftwareEngineering/blob/main/pic/13.png)
## Выводы
...
![Меню](https://github.com/Knysha04/SoftwareEngineering/blob/main/pic/14.png)
...
## Задание 15
### Настройка .gitignore
![Меню](https://github.com/Knysha04/SoftwareEngineering/blob/main/pic/15.png)
## Выводы
