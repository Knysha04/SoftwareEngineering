...
#### Результат 1:
![Меню](https://github.com/Knysha04/SoftwareEngineering/blob/main/pic/Tema5.1(1).png)

#### Результат 2:
![Меню](https://github.com/Knysha04/SoftwareEngineering/blob/main/pic/Tema5.1(2).png)
...
```
#### Результат 1:
![Меню](https://github.com/Knysha04/SoftwareEngineering/blob/main/pic/Tema5.2(1).png)

#### Результат 2:
![Меню](https://github.com/Knysha04/SoftwareEngineering/blob/main/pic/Tema5.2(2).png)
...
```
#### Результат:
![Меню](https://github.com/Knysha04/SoftwareEngineering/blob/main/pic/Tema5.3.png)
...
```
#### Результат:
![Меню](https://github.com/Knysha04/SoftwareEngineering/blob/main/pic/Tema5.4.png)
...
```
#### Результат:
![Меню](https://github.com/Knysha04/SoftwareEngineering/blob/main/pic/Tema5.5.png)
...
```
#### Результат:
![Меню](https://github.com/Knysha04/SoftwareEngineering/blob/main/pic/Tema5.6.png)
...
```
#### Результат:
![Меню](https://github.com/Knysha04/SoftwareEngineering/blob/main/pic/Tema5.7.png)
...
```
#### Результат:
![Меню](https://github.com/Knysha04/SoftwareEngineering/blob/main/pic/Tema5.8.png)
...
```
#### Результат:
![Меню](https://github.com/Knysha04/SoftwareEngineering/blob/main/pic/Tema5.9.png)
...
```
#### Результат:
![Меню](https://github.com/Knysha04/SoftwareEngineering/blob/main/pic/Tema5.10.png)
...
```
#### Результат:
![Меню](https://github.com/Knysha04/SoftwareEngineering/blob/main/pic/Tema5.11.png)
...
```
#### Результат:
![Меню](https://github.com/Knysha04/SoftwareEngineering/blob/main/pic/Tema5.12.png)
...
```
#### Результат:
![Меню](https://github.com/Knysha04/SoftwareEngineering/blob/main/pic/Tema5.13.png)
...
```
#### Результат:
![Меню](https://github.com/Knysha04/SoftwareEngineering/blob/main/pic/Tema5.14.png)
...
```
#### Результат:
![Меню](https://github.com/Knysha04/SoftwareEngineering/blob/main/pic/Tema5.15.png)
...
# Общий вывод: Эти задачи предоставляют отличную практику работы с данными в программировании. Они демонстрируют использование циклов, условных операторов и различных способов обработки списков и множеств. В итоге, вы сможете увереннее применять эти знания для решения различных задач с данными, будь то проверка супермножеств, обработка списков или создание многомерных структур.
