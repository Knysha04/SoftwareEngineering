...
![Меню](https://github.com/Knysha04/SoftwareEngineering/blob/main/pic/Еще%205%20задание.png)
...
## Общий вывод
### Выполненные задания способствовали повторению ключевых операций и функций языка Python, что позволяет лучше понять язык и расширить знания о его возможностях.
